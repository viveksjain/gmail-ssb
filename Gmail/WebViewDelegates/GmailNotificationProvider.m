...
//
//  Largely based on code from https://github.com/jnordberg/irccloudapp
//
...
+ (id)sharedNotificationProvider
{
    static NotificationProvider *instance = nil;
    @synchronized(self) {
        if (instance == nil) {
            instance = [[NotificationProvider alloc] init];
        }
        return instance;
    }
}
